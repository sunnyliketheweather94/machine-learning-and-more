...
- [Statistical Inference](./statistical_inference/) where I work through the homework sets to brush up on my statistical inference and mathematical statistics knowledge (both theory and computation in Python, not R).
